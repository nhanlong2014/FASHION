...
public class AoPoloActivity extends AppCompatActivity {
    Toolbar toolbar;
    EditText edt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aopolo);
        setToolbar();
    ...
    public void getProductById() {
        ...
        rcv = findViewById(R.id.rcvPolos);
        rcv.setHasFixedSize(true);
        rcv.setLayoutManager(new GridLayoutManager(getApplication(), 2));

        Call<ListResponse> call = RetrofitClient.getApiClient().create(Api.class).getProductID4();
